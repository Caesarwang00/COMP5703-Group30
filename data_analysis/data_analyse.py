...
运行:  python data_analysis/data_analyse.py
"""
...
BASE_DIR = os.path.normpath(os.path.join(HERE, "..", "data_RNA"))

FILES = {
    "mutation":  os.path.join(BASE_DIR, "MUT"),
    "cnv_thres": os.path.join(BASE_DIR, "CNV"),
    "methyl450": os.path.join(BASE_DIR, "METH450"),
    # 注意：这里的 HiSeqV2 是 RNA-seq（不是 miRNA）
    "rnaseq":    os.path.join(BASE_DIR, "RNA"),
    "clinical":  os.path.join(BASE_DIR, "GBM_clinicalMatrix"),
}
